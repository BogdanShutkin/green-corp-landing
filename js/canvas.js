...
class Bubble {
    ...
    init() {
        ...
        this.alpha = generateDecimalBetween(5, 10) / 10; // this.alpha = (Math.random() * (10 - 5) + 5)/10;
        this.size = generateDecimalBetween(1, 3); // this.size = Math.random() * (3 - 1) + 1;
        this.translateX = generateDecimalBetween(0, this.canvasWidth); // this.translateX = Math.random() * (this.canvasWidth - 0) + 0;
        this.translateY = generateDecimalBetween(0, this.canvasHeight); // this.translateY = Math.random() * (this.canvasHeight - 0) + 0;
